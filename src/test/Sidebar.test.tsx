...
describe('Sidebar', () => {
  ...
  it('calls onSelect with project id when clicked', () => {
    ...
    render(<Sidebar projectTree={tree} selectedId={null} onSelect={onSelect} onDelete={vi.fn()} onAdd={vi.fn()} onAddSubProject={vi.fn()} onOpenShellIntegration={vi.fn()} onOpenSettings={vi.fn()} onImportFromExample={vi.fn()} />)
    screen.getByText('my-api').closest('[role="button"]')!.dispatchEvent(new MouseEvent('click', { bubbles: true }))
    expect(onSelect).toHaveBeenCalledWith('p1')
  })

  it('shows empty state when no projects', () => {
    render(<Sidebar projectTree={[]} selectedId={null} onSelect={vi.fn()} onDelete={vi.fn()} onAdd={vi.fn()} onAddSubProject={vi.fn()} onOpenShellIntegration={vi.fn()} onOpenSettings={vi.fn()} onImportFromExample={vi.fn()} />)
    expect(screen.getByText(/No projects yet/i)).toBeInTheDocument()
  })

  it('marks selected project as active', () => {
    const tree = [makeNode('p1', 'selected-proj')]
    render(<Sidebar projectTree={tree} selectedId="p1" onSelect={vi.fn()} onDelete={vi.fn()} onAdd={vi.fn()} onAddSubProject={vi.fn()} onOpenShellIntegration={vi.fn()} onOpenSettings={vi.fn()} onImportFromExample={vi.fn()} />)
  ...
  it('calls onAdd when add project button is clicked', () => {
    const onAdd = vi.fn()
    render(<Sidebar projectTree={[]} selectedId={null} onSelect={vi.fn()} onDelete={vi.fn()} onAdd={onAdd} onAddSubProject={vi.fn()} onOpenShellIntegration={vi.fn()} onOpenSettings={vi.fn()} onImportFromExample={vi.fn()} />)
  ...
  it('shows var count correctly for plural', () => {
    ...
    render(<Sidebar projectTree={[nodeWithVars]} selectedId={null} onSelect={vi.fn()} onDelete={vi.fn()} onAdd={vi.fn()} onAddSubProject={vi.fn()} onOpenShellIntegration={vi.fn()} onOpenSettings={vi.fn()} onImportFromExample={vi.fn()} />)
  ...
  it('shows var count correctly for singular', () => {
    ...
    render(<Sidebar projectTree={[nodeWithVar]} selectedId={null} onSelect={vi.fn()} onDelete={vi.fn()} onAdd={vi.fn()} onAddSubProject={vi.fn()} onOpenShellIntegration={vi.fn()} onOpenSettings={vi.fn()} onImportFromExample={vi.fn()} />)
