...
describe('Sidebar', () => {
  ...
  it('shows var count correctly for plural', () => {
    ...
    render(<Sidebar projectTree={[nodeWithVars]} selectedId={null} onSelect={vi.fn()} onDelete={vi.fn()} onAdd={vi.fn()} onAddSubProject={vi.fn()} onOpenShellIntegration={vi.fn()} onOpenSettings={vi.fn()} />)
