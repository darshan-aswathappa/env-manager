...
describe('VarList', () => {
  it('shows select a project when project is null', () => {
    render(<VarList project={null} selectedVarId={null} searchQuery="" onSearchChange={vi.fn()} onSelectVar={vi.fn()} onAddVar={vi.fn()} />)
  ...
  it('filters vars by search query', () => {
    ...
    render(<VarList project={project} selectedVarId={null} searchQuery="database" onSearchChange={vi.fn()} onSelectVar={vi.fn()} onAddVar={vi.fn()} />)
    expect(screen.getByText('DATABASE_URL')).toBeInTheDocument()
  ...
  it('shows no results message when search finds nothing', () => {
    ...
    render(<VarList project={project} selectedVarId={null} searchQuery="zzz" onSearchChange={vi.fn()} onSelectVar={vi.fn()} onAddVar={vi.fn()} />)
  ...
  it('calls onAddVar when + button is clicked', () => {
    ...
    const project = makeProject([])
    render(<VarList project={project} selectedVarId={null} searchQuery="" onSearchChange={vi.fn()} onSelectVar={vi.fn()} onAddVar={onAddVar} />)
  ...
  it('calls onSearchChange when search input changes', () => {
    ...
    render(<VarList project={project} selectedVarId={null} searchQuery="" onSearchChange={onSearchChange} onSelectVar={vi.fn()} onAddVar={vi.fn()} />)
  ...
  it('marks selected var as active', () => {
    ...
    const project = makeProject([v])
    render(<VarList project={project} selectedVarId={v.id} searchQuery="" onSearchChange={vi.fn()} onSelectVar={vi.fn()} onAddVar={vi.fn()} />)
