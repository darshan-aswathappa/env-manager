...
import { CheckCircle2, XCircle, Loader2, Terminal, ArrowLeft } from "lucide-react";
...
export default function Onboarding({ onComplete }: OnboardingProps) {
  ...
  function navigateTo(nextStep: Step) {
    ...
    swapTimer.current = setTimeout(() => {
      ...
      // Clean up the animation class so it doesn't interfere with future transitions
      ...
      <div className="ob-card">
        ...
        <div className={`ob-step${animClass ? ` ${animClass}` : ""}`}>
          ...
          {renderedStep === "welcome" && (
            <>
              ...
              <p className="ob-subtitle">
                ...
                Keep your <code className="ob-code">.env</code> files organized,
                inheritable, and automatically loaded in your terminal.
              </p>
              <div className="ob-feature-list">
                ...
                <div className="ob-feature">
                  <span className="ob-feature-dot" />
                  Shell hook auto-loads vars when you <code className="ob-code">cd</code> into a directory
                </div>
                <div className="ob-feature">
                  <span className="ob-feature-dot" />
              ...
              <div className="ob-actions">
                <button className="ob-btn-primary" onClick={() => navigateTo("install")}>
                  Get Started
                </button>
              </div>
            </>
          ...
          {renderedStep === "install" && (
            <>
              <button className="ob-btn-back" onClick={() => navigateTo("welcome")}>
              ...
              <p className="ob-subtitle">
                ...
                environment variables whenever you <code className="ob-code">cd</code> into a
                project directory — no manual sourcing needed.
              </p>
              <div className="ob-shell-embed">
                <ShellIntegration />
              </div>
              <div className="ob-actions">
                <button className="ob-btn-primary" onClick={() => navigateTo("verify")}>
          ...
          {renderedStep === "verify" && (
            <>
              <button className="ob-btn-back" onClick={() => navigateTo("install")}>
                <ArrowLeft size={13} aria-hidden="true" />
                Back
              </button>
              <h1 className="ob-title">Verify your setup</h1>
              <p className="ob-subtitle">
                Shell integration is required for .envVault to work. Confirm the
                hook is detected in your config file before continuing.
              </p>
              ...
              <div className="ob-verify-area">
                ...
                {verifyStatus === "found" && (
                  <div className="ob-verify-status ob-verify-status--found">
                    ...
                    Hook found in{" "}
                    <strong>
                      {foundShell ? SHELL_LABEL[foundShell] ?? foundShell : "your shell"}
                    </strong>
                  </div>
                )}
                ...
                {verifyStatus === "not_found" && (
                  <div className="ob-verify-not-found">
                    ...
                    <p className="ob-verify-hint">
                      Paste the snippet into <code className="ob-code">~/.zshrc</code> or{" "}
                      <code className="ob-code">~/.bashrc</code>, save the file, then check again.
                    </p>
                    <div className="ob-verify-retry-row">
                      <button className="ob-btn-check" onClick={handleVerify}>
                        Check again
                      </button>
                      <button className="ob-btn-ghost" onClick={() => navigateTo("install")}>
